        ...
        <Row className="gy-5 align-items-start">
          ...
          >
            <h2 className="title-2 text-white mb-4">
              Our Innovative e-commerce services
            </h2>
          ...
          >
            <div className="py-4">
              <div className="card-body">
                <h3 className="mb-3">Custom E-Commerce Software Development</h3>
                <p className="fs-16 text-dark-gray mb-0">
                  Tailored e-commerce solutions designed to meet the unique
                  needs of your business, from online storefronts to
            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="fs-16 text-dark-gray mb-0">
                  ...
                  strategic planning for ecommerce operations.
                </p>
              </div>
            </div>
            <div className="card">
              <div className="card-body">
                ...
                <p className="fs-16 text-dark-gray mb-0">
                  Robust tools that facilitate seamless transactions, enhance
                  customer experience, and ensure secure payment processing.
                </p>
              </div>
            </div>
            <div className="card">
              <div className="card-body">
                ...
                <p className="fs-16 text-dark-gray mb-0">
                  Comprehensive systems that help e-commerce businesses manage
            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="fs-16 text-dark-gray mb-0">
                  ...
                  and ensure timely procurement and delivery of products.
                </p>
              </div>
            </div>
          </Col>
