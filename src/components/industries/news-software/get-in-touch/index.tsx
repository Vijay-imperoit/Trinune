        ...
        <Row className="row gy-4 align-items-center">
          ...
          >
            <div className="ps-xl-5 ms-xl-5 ps-lg-5 p-4">
              <h3 className="title">
                Ready to Level Up Your News Platform with Custom Solutions?
              </h3>
              <p className="sub-title">
                Connect with us to discuss your needs and explore custom news
                software solutions designed to enhance reader engagement,
                optimize content management, and ensure security and efficiency
                across your news platforms.
              </p>
