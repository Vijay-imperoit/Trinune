            ...
            <Row className="align-items-center gy-4">
              <Col lg={9}>
                <h3 className="title-3">
                  Why Impero is Your Trusted IT Partner for News Software!
                </h3>
                <Row>
                  <Col lg={12}>
                    <p className="list-item">
                      Expertise in custom news platform solutions.
                    </p>
                    <p className="list-item">
                      Proven success in enhancing reader engagement and
                      satisfaction.
                    </p>
                    <p className="list-item">
                    ...
                    <p className="list-item">
                      Support for seamless integration in news ecosystems.
                    </p>
                  </Col>
                </Row>
              </Col>
