            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Enhance Attendee Experience</h3>
                </div>
                <p className="pera mb-0">
                  Our event solutions streamline processes, reduce wait times,
                  and enhance the overall event experience, allowing you to
                  focus on attendee satisfaction and engagement.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Strengthen Event Management</h3>
                </div>
                <p className="pera mb-0">
                  With our advanced event management systems, we help you
                  optimize planning, improve coordination, and ensure timely
                  execution of all event activities.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  ...
                  relationships with attendees, vendors, and sponsors.
                </p>
              </div>
            </div>
          </div>
