        ...
        <Row className="gy-5 align-items-start">
          ...
          >
            <h2 className="title-2 text-white mb-4">
              Our Innovative Retail services
            </h2>
          ...
          >
            <div className="py-4">
              <div className="card-body">
                <h3 className="mb-3">Custom Retail Software Development</h3>
                <p className="fs-16 text-dark-gray mb-0">
                  Tailored retail solutions designed to meet the unique needs of
                  your business, from e-commerce platforms to comprehensive
            ...
            <div className="card">
              <div className="card-body">
                <h3 className="mb-3">Point of Sale (POS) Systems</h3>
                <p className="fs-16 text-dark-gray mb-0">
                  Robust tools that streamline transactions, enhance customer
                  experience, and provide real-time sales data to optimize
                  operations.
                </p>
              </div>
            </div>
            <div className="card">
              <div className="card-body">
                ...
                <p className="fs-16 text-dark-gray mb-0">
                  Comprehensive systems that help retailers manage customer
            ...
            <div className="card">
              <div className="card-body">
                <h3 className="mb-3">Supply Chain Management Tools</h3>
                <p className="fs-16 text-dark-gray mb-0">
                  Solutions designed to optimize your supply chain, ensuring
                  efficiency, cost-effectiveness, and timely delivery of
                  products.
                </p>
              </div>
            </div>
