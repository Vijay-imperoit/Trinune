            ...
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  Our retail solutions streamline processes, reduce wait times,
                  and enhance the shopping experience, allowing you to focus on
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Strengthen Inventory Management</h3>
                </div>
                <p className="pera mb-0">
                  With our advanced inventory management systems, we help you
                  maintain optimal stock levels, reduce shrinkage, and ensure
