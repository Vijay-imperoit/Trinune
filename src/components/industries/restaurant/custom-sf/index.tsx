          ...
          <Row className="gy-3">
            <Col lg={8}>
              <h2 className="title-2">
                The value of custom restaurant
                <br />
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  Our restaurant solutions streamline processes, reduce wait
                  times, and enhance the dining experience, allowing you to
          ...
          <div className="card">
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  With our advanced online ordering and delivery systems, we
                  help you optimize order processing, improve accuracy, and
                  ensure timely delivery of meals.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  ...
                  opportunities in the restaurant market.
                </p>
              </div>
            </div>
          </div>
