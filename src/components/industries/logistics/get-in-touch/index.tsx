        ...
        <Row className="row gy-4 align-items-center">
          ...
          >
            <div className="ps-xl-5 ms-xl-5 ps-lg-5 p-4">
              <h3 className="title">
                Ready to Optimize Your Logistics Platform with Custom Solutions?
              </h3>
              <p className="sub-title">
                Connect with us to discuss your needs and explore custom
                logistics software solutions designed to streamline operations,
                enhance fleet management, and ensure real-time tracking and
                security across your logistics network.
              </p>
