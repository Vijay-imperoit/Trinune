            ...
            <Row className="align-items-center gy-4">
              <Col lg={9}>
                <h3 className="title-3">
                  Why Impero is Your Trusted IT Partner for Real Estate
                  Software!
                </h3>
                <Row>
                  <Col lg={12}>
                    <p className="list-item">
                      Expertise in custom real estate platform solutions.
                    </p>
                    <p className="list-item">
                    ...
                    <p className="list-item">
                      Focus on improving platform scalability and property
                      personalization.
                    </p>
                    <p className="list-item">
                      Support for seamless integration in real estate
                      ecosystems.
                    </p>
                  </Col>
                </Row>
