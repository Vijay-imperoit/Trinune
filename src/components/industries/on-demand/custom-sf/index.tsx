            ...
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  Our on-demand solutions streamline processes, reduce wait
                  times, and enhance the service experience, allowing you to
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Strengthen Service Delivery</h3>
                </div>
                <p className="pera mb-0">
                  With our advanced service management systems, we help you
                  optimize resource allocation, improve response times, and
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  ...
                  opportunities in the on-demand market.
                </p>
              </div>
            </div>
          </div>
