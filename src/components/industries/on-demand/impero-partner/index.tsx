            ...
            <Row className="align-items-center gy-4">
              <Col lg={9}>
                <h3 className="title-3">
                  Why Impero is your trusted partner for on-demand software
                </h3>
                <Row>
                  <Col lg={12}>
                    <p className="list-item">
                      Expertise in custom, scalable software solutions.
                    </p>
                    <p className="list-item">
                      Proven success across diverse industries.
                    </p>
                    <p className="list-item">
                      Focus on optimizing operations and user experiences.
                    </p>
                    <p className="list-item">
