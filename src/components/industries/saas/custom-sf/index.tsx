            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Enhance User Experience</h3>
                </div>
                <p className="pera mb-0">
                  Our SaaS solutions streamline processes, reduce friction in
                  user interactions, and enhance overall satisfaction, allowing
                  you to focus on customer retention and loyalty.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Strengthen Data Security</h3>
                </div>
                <p className="pera mb-0">
                  With our advanced security protocols, we help protect
                  sensitive data and ensure compliance with industry
                  regulations, providing peace of mind for your users.
                </p>
              </div>
            </div>
          </div>
