            ...
            <Row className="align-items-center gy-4">
              <Col lg={9}>
                <h3 className="title-3">
                  Why Impero is Your Trusted IT Partner for Manufacturing!
                </h3>
                <Row>
                  <Col lg={12}>
                    <p className="list-item">
                      Expertise in delivering manufacturing-specific IT
                      solutions.
                    </p>
                    <p className="list-item">
                      Proven track record with global manufacturing clients.
                    </p>
                    <p className="list-item">
                      Focus on process optimization and scalable solutions.
                    </p>
                    <p className="list-item">
