            ...
            <div className="card-body d-flex align-items-center">
              <div>
                ...
                <p className="pera mb-0">
                  Our manufacturing solutions streamline processes, reduce
                  manual errors, and automate workflows, allowing you to focus
                  on strategic initiatives and operational excellence.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Strengthen Quality Assurance</h3>
                </div>
                <p className="pera mb-0">
                  With our advanced quality control systems, we help ensure that
                  your products meet the highest standards, reducing waste and
            ...
            <div className="card-body d-flex align-items-center">
              <div>
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  <h3 className="title">Improve Supply Chain Management</h3>
                </div>
                <p className="pera mb-0">
                  We design integrated supply chain solutions that enhance
