...
const HeroSection = () => {
  return (
    <section className="hero-section-inpractice section-inpractice-hero overflow-hidden custom-blog-cursor">
          ...
          <Col lg={6}>
            <div className="hero-contain">
              ...
              <p className="fs-24 fw-bolder bottom-line position-relative">
                Efficient Cloud Based Audit Tool
              </p>
