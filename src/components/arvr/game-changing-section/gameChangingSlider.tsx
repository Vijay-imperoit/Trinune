    ...
    <div className='game-slider custom-blog-cursor'>
      <div className='card industry-card-startups'>
        <div className='card-body'>
          ...
          <p className='text'>
            Transform your manufacturing processes with innovative AR/VR
            solutions. Enhance productivity, streamline operations, and improve
        ...
        <div className='card-body'>
          <div className='icon'>
            <svg
              ...
              xmlns='http://www.w3.org/2000/svg'
            >
              <rect y='0.5' width='52' height='52' rx='8' stroke='white' />
              <path
          ...
          <p className='text'>
            Revolutionize patient care with AR/VR solutions. Experience enhanced
            diagnostics, simulations, and virtual consultations to improve
            outcomes.
          </p>
        </div>
        <div className='card-img'>
      ...
      <div className='card industry-card-startups'>
        <div className='card-body'>
          ...
          <p className='text'>
            Boost retail experiences with AR/VR applications. Engage customers
            through virtual try-ons, demos, and interactive shopping, building
            brand loyalty.
          </p>
        </div>
        <div className='card-img'>
      ...
      <div className='card industry-card-startups'>
        <div className='card-body'>
          ...
          <p className='text'>
            Enhance financial services with AR/VR to deliver immersive
            experiences for customer engagement, training, and risk management.
          </p>
        </div>
        <div className='card-img'>
          <img
      ...
      <div className='card industry-card-startups'>
        <div className='card-body'>
          ...
          <p className='text'>
            Create unforgettable experiences with AR/VR solutions. Engage
            audiences with interactive storytelling and immersive content.
          </p>
        </div>
        <div className='card-img'>
          <img
